  ...
  <Layout>
    ...
    <section className="container py-14 md:py-20">
      ...
      <div className="mt-14 rounded-3xl bg-gradient-primary text-primary-foreground p-10 md:p-14 shadow-warm text-center">
        ...
        <a href={waExperience()} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 bg-background text-primary px-6 py-3.5 rounded-full font-semibold hover-lift">
